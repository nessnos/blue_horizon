  ...
  <div class="w-72">
    ...
    <Listbox v-model="selectedData">
      <div class="relative mt-1">
        ...
        >
          <div class="flex flex-row items-center gap-3" v-if="selectedData">
            <span
              v-if="flag && selectedData.name != 'Tout'"
              class="fi rounded-[0.2rem] shadow"
              :class="'fi-' + selectedData.code?.toLowerCase()"
            ></span>
        ...
        >
          <ListboxOptions
            class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-ocean/50 bg-white py-1 text-sm shadow-md"
          >
            <ListboxOption
            ...
            >
              <li
                :class="[
                  active
                    ? 'bg-ocean text-white transition-all duration-200 ease-in-out'
                    : 'text-gray-900',
              ...
              >
                <div class="flex flex-row items-center gap-3">
                  <span
                    v-if="flag && data.name != 'Tout'"
                    class="fi rounded-[0.2rem] shadow"
                    :class="'fi-' + data.code?.toLowerCase()"
                  ></span>
                  <span
                    :class="[
